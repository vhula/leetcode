...
@Problem(title = "217. Contains Duplicate",
    ...
    topics = {Topic.ARRAY, Topic.HASH_TABLE, Topic.SORTING}, difficulty = Difficulty.EASY)
public class ContainsDuplicate {
  ...
  @Solution(timeComplexity = @TimeComplexity(Complexity.N_LOG_N),
      spaceComplexity = {
          @SpaceComplexity(value = Complexity.CONSTANT,
              details = "if the sorting algorithm is in-place"),
          @SpaceComplexity(value = Complexity.LINEAR,
              details = "if the sorting algorithm is not in-place")},
