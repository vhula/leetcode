...
@Problem(title = "242. Valid Anagram", leetcodeUrl = "https://leetcode.com/problems/valid-anagram/",
    topics = {Topic.HASH_TABLE, Topic.SORTING, Topic.STRING}, difficulty = Difficulty.EASY)
public class ValidAnagram {
  ...
  @Solution(timeComplexity = @TimeComplexity(Complexity.LINEAR_N_PLUS_M),
      spaceComplexity = @SpaceComplexity(Complexity.CONSTANT),
  ...
  @Solution(timeComplexity = @TimeComplexity(Complexity.N_LOG_N_PLUS_M_LOG_M),
      spaceComplexity = @SpaceComplexity(Complexity.CONSTANT),
